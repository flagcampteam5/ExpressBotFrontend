...
class Service extends Component {
    constructor() {
        ...
        this.handleDestinationAddress = this.handleDestinationAddress.bind(
            this
        );
        ...
        return (
            <div className="Block">
                <div className="introduction">
                    ...
                    <span>
                        ExpressBot is dedicated to the delivery of packages
                        within the city of San Francisco using drones and road
                        bots. ExpressBot aims to support the effort in fighting
                        the current pandemic by reducing human contact. When you
                        place an order, a road bot or a drone based on your
                        choosing is sent to pick up the parcel from the closest
                        station situated in San Francisco. Simply fill out a
                        request, wait for a robot to pick up the parcel, and
                        rest assured that your parcel will be delivered safely
                        to its destination.
                    </span>
                </div>
                <div className="img">
                            ...
                            <Button className="ServiceButton" type="primary">
                                <Link
                                    to={{
                                        pathname: "/request",
                                        state: {
                                            pickUpAddress: this.state
                                                .pickUpAddress,
                                            pickUpLatLng: this.state
                                                .pickUpLatLng,
                                            destinationAddress: this.state
                                                .destinationAddress,
                                            destinationLatLng: this.state
                                                .destinationLatLng,
                                        },
                                    }}
                                >
